            ...
            <form method="GET">
                ...
                <div class="form-group">
                    ...
                    <select id="preco" name="filtros[preco]" class="form-control">
                        <option></option>
                        <option value="0-05" <?php echo ($filtros['preco']=='0-50')?'selected="selected"':''; ?>>R$ 0 - 50</option>
                    ...
                    <?php foreach($anuncios as $anuncio): ?>
                      <tr>
                          <td>
                            ...
                            <img src="assets/images/anuncios/<?php echo $anuncio['url']; ?>" border="0" width="55">
                            <?php else: ?>
                            <img src="assets/images/anuncios/default.jpg" border="0" width="55">
                            <?php endif; ?>
                          </td>
                          <td>
